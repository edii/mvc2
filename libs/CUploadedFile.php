...
//            ]); // new static
             ...
             self::$_files[$key] ->name = $names;   
             self::$_files[$key] ->tempName = $tempNames;
             self::$_files[$key] ->type = $types;
             self::$_files[$key] ->size = $sizes;
             self::$_files[$key] ->error = $errors;
