...
class CBreadcrumbs extends \CApplicationComponent 
{
	...
	public function init()
	{
        ...
        public function setLinks( $links ) {
            $this -> links = (is_array($links)) ? $links : null;
            return $this;
        }
		...
		self::$breadcrumbs = \CHtml::openTag($this->tagName,$this->htmlOptions)."\n";
		$links=array();
		if($this->homeLink===null)
			$definedLinks=array_merge(array( 'home' => \init::app()->homeUrl),$definedLinks);
		...
		self::$breadcrumbs .= implode($this->separator,$links);
		self::$breadcrumbs .= \CHtml::closeTag($this->tagName);
