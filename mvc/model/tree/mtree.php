    ...
    public function getTree() {
        ...
        if(is_array($sections) and count($sections) > 0) :
            foreach($sections as $key=>$_section):
                $this->_tree[$_section -> id] = (array)$_section;
                $this->_tree[$_section -> id]['childs'] = $this->_getCreateTree((array)$_section, 0);
            endforeach;
        endif;
